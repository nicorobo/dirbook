...
program.command('ls')
	...
	.action(lib.list)
program.command('bp')
	.description('List options for configuring bp settings.')
	.option('-a, --active <active>', 'Turn bashProfile editing on or off')
	.option('-p, --path <path>', 'Change path of bashProfile')
	.action(lib.bpSettings)
