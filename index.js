...
program.command('alias')
	.description('Configure alias settings')
	.option('-o, --active', 'Turn alias editing on')
	.option('-f, --off', 'Turn alias editing off')
	.option('-x, --prefix <prefix>', 'Changes the alias\'s prefix.')
